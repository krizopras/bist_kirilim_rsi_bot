...
ALL_BIST_STOCKS = [
    "ADEL", "ADESE", "ADGYO", "AFYON", "AGHOL", "AGESA", "AGROT", "AHSGY", "AHGAZ",
    "AKBNK", "AKCNS", "AKYHO", "AKENR", "AKFGY", "AKFYE", "ATEKS", "AKSGY", "AKMGY",
    ...
    "AYES", "AYGAZ", "AZTEK", "A1CAP", "BAGFS", "BAHKM", "BAKAB", "BALAT",
    "BALSU", "BNTAS", "BANVT", "BARMA", "BSRFK", "BASGZ", "BASCM", "BEGYO", "BTCIM", "BSOKE",
    "BYDNR", "BAYRK", "BERA", "BRKT", "BRKSN", "BJKAS", "BEYAZ", "BIENY", "BLCYT",
    "BIMAS", "BINBN", "BIOEN", "BRKVY", "BRKO", "BIGEN", "BRLSM", "BRMEN", "BIZIM",
    "BMSTL", "BMSCH", "BNPPI", "BOBET", "BORSK", "BORLS", "BRSAN", "BRYAT", "BFREN", "BOSSA",
    "BRISA", "BURCE", "BURVA", "BUCIM", "BVSAN", "BIGCH","CRFSA", "CASA", "CEMZY", "CEOEM", 
    "CCOLA", "CONSE", "COSMO", "CRDFA", "CVKMD", "CWENE",
    "CAGFA", "CANTE", "CATES", "CLEBI", "CELHA", "CLKMT", "CEMAS", "CEMTS", "CMBTN",
    "CMENT", "CIMSA", "CUSAN", "DVRLK", "DAGI", "DAPGM", "DARDL", "DGATE", "DCTTR",
    "DGRVK", "DMSAS", "DENGE", "DENFA", "DNFIN", "DZGYO", "DZY", "DZYMK", "DENIZ", "DNZ",
    "DERIM", "DERHL", "DESA", "DESPC", "DEVA", "DNISI", "DIRIT",
    "DMRGD", "DOCO", "DOFER", "DOBUR", "DOHOL", "DGNMO", "ARASE", "DOGUB", "DGGYO",
    ...
    "DMLKT", "EKGYO","ENJSA", "ENERY", "ENKAI", "ENSRI", "ERBOS", "ERCB",
    "EREGL", "KIMMR", "ERSU", "ESCAR", "ESCOM", "ESEN", "ETILR", "EUKYO", "EUYO", "ETYAT",
    "EUHOL", "TEZOL", "EUREN", "EUPWR", "EYGYO", "FADE", "FSDAT", "FMIZP", "FENER",
    "FBBNK", "FLAP", "FONET", "FROTO", "FORMT", "FORTE", "FRIGO", "FZLGY", "GWIND",
    "GSRAY", "GARFA", "GARFL", "GRNYO", "GEDIK", "GEDZA", "GLCVY", "GENIL", "GENTS", "GEREL",
    "GZNMI", "GIPTA", "GMTAS", "GESAN", "GLBMD", "GLYHO", "GGBVK", "GOODY",
    "GOKNR", "GOLTS", "GOZDE", "GRTHO", "GSDDE", "GSDHO", "GUBRF", "GLRYH", "GLRMK", "GUNDG",
    "GRSEL", "SAHOL", "HALKF", "HLGYO", "HLVKS", "HALKI", "HRKET", "HATEK", "HATSN",
    "HDFGS", "HEDEF", "HDFVK", "HDFYB", "HYB", "HEKTS", "HEPFN", "HKTM",
    "HTTBT", "HOROZ", "HUBVC", "HUNER", "HUZFA", "HURGZ", "ENTRA", "ICBCT",
    "INGRM", "INVEO",  "INVAZ", "INVES", "ISKPL", "IEYHO", "IDGYO", "IHEVA", "IHLGM",
    "IHGZT", "IHAAS", "IHLAS", "IHYAY", "IMASM",  "INDES", "INFO", "INTEK",
    "INTEM", "IPEKE", "ISDMR", "ISTFK", "ISFAK", "ISFIN", "ISGYO", "ISGSY", "ISMEN",
    ...
    "KOCMT", "KLSYN", "KNFRT", "KONTR", "KONYA", "KONKA", "KGYO", "KORDS", "KRPLS",
    "KOTON", "KOZAL", "KOZAA", "KOPOL", "KRGYO", "KRSTL", "KRONT", "KTKVK", "KSTUR",
    "KUVVA", "KUYAS", "KBORU", "KZGYO", "KUTPO", "KTSKR", "LIDER", "LIDFA", "LILAK",
    "LMKDC", "LINK", "LOGO", "LKMNH", "LRSHO", "LUKSK", "LYDHO", "LYDYE", "MACKO", "MAKIM",
    "MAKTK", "MANAS", "MRBAS", "MAGEN", "MRMAG", "MARKA", "MAALT", "MRSHL", "MRGYO",
    "MARTI", "MTRKS", "MAVI", "MZHLD", "MEDTR", "MEGMT", "MEGAP", "MEKAG", "MEKMD", "MSA",
    "MNDRS", "MEPET", "MERCN", "MRBKF", "MBFTR", "MERIT", "MERKO", "METUR", "METRO", "MTRYO",
    "MHRGY", "MIATK", "MGROS", "MSGYO", "MSYBN", "MPARK", "MMCAS", "MNGFA", "MOBTL",
    "MOGAN", "MNDTR", "MOPAS", "EGEPO", "NATEN", "NTGAZ", "NTHOL", "NETAS", "NIBAS", "NUHCM",
    "NUGYO", "NRHOL", "OBAMS", "OBASE", "ODAS", "ODINE",
    "OFSYM", "ONCSM", "ONRYT", "OPET", "ORCAY", "ORFIN", "ORGE", "ORMA", "OSMEN",
    "OSTIM", "OTKAR", "OTTO", "OYAKC",  "OYYAT", "OYAYO", "OYLUM",
    "OZKGY", "OZATD", "OZGYO", "OZRDN", "OZSUB", "OZYSR", "PAMEL", "PNLSN", "PAGYO", "PAPIL",
    "PRFFK", "PRDGS", "PRKME",  "PASEU", "PSGYO", "PATEK", "PCILT",
    "PGSUS", "PEKGY", "PENGD", "PENTA", "PSDTC", "PETKM", "PKENT", "PETUN", "PINSU", "PNSUT",
    "PKART", "PLTUR", "POLHO", "POLTK", "PRZMA",
    "QNBTR", "QUAGR", "QUFIN", "RNPOL", "RALYH", "RAYSG", "REEDR",
    ...
    "SURGY", "SUWEN", "SMRFA", "SMRVA", "SEKFK", "SEGYO", "SKYMD", "SEK",
    "SKBNK", "SOKM", "TABGD", "TCRYT", "TAMFA", "TNZTP", "TARKM", "TATGD", "TATEN",
    "TAVHL", "DRPHN", "TEBFA", "TEKTU", "TKFEN", "TKNSA", "TMPOL", "TRFFA", "DAGHL",
    "TAE", "TRBNK", "TERA",  "TEHOL", "TGSAS", "TRYKI", "TOASO",
    "TRGYO", "TLMAN", "TSPOR", "TDGYO", "TRMEN", "TSGYO", "TUCLK", "TUKAS", "TRCAS",
    "TUREX", "MARBL", "TRKFN", "TRILC", "TCELL", "TMSN", "TUPRS",
    "THYAO", "PRKAB", "TTKOM", "TTRAK", "TBORG", "TURGG", "GARAN", "HALKB",
    "EXIMB",  "ISCTR", "ISKUR", "KLNMA", "TSKB",
    "TURSG", "SISE", "VAKBN", "UFUK", "ULAS", "ULUFA", "ULUSE", "ULUUN",
    "UMPAS", "USAK", "ULKER", "UNLU", "VAKFN", "VKGYO", "VKFYO", "VAKKO",
    "VANGD", "VBTYZ", "VDFFA", "VRGYO", "VERUS", "VERTU", "VESBE", "VESTL", "VKING",
    "VSNMD", "VDFAS", "YKFKT", "YKFIN", "YKR", "YKYAT", "YKB", "YKBNK", "YAPRK", "YATAS",
     "YFMEN", "YATVK", "YYLGD", "YAYLA", "YGGYO", "YEOTK", "YGYO", "YYAPI", "YESIL",
